...
using CustomControls.iOS.Renderers.Frame;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(CustomFrame), typeof(CustomFrameRenderer))]
namespace CustomControls.iOS.Renderers.Frame
{
    public class CustomFrameRenderer : VisualElementRenderer<CustomFrame>
    {
        ...
        private void SetGradientColor()
        {
            ...
            if (element.HasShadow)
            {
                ...
                gradientLayer.ShadowOpacity = 0.6f;
                gradientLayer.ShadowRadius = 1.0f;
                gradientLayer.ShadowOffset = new SizeF(0, 0);
            }
